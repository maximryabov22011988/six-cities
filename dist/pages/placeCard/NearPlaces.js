...
function NearPlaces({ offers, onAddToFavorities, onRemoveFromFavorities }) {
    return (React.createElement("div", { className: "container" },
        React.createElement("section", { className: "near-places places" },
            ...
            React.createElement(PlaceCardList_1.default, { offers: offers, parentClassName: "near-places", onAddToFavorities: onAddToFavorities, onRemoveFromFavorities: onRemoveFromFavorities }))));
}
