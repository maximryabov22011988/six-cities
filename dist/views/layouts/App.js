...
class App extends React.Component {
    ...
    render() {
        const { favoriteOffers, isReadyApp, isAuthUser, user, currentCity, cities, offers, changeCity, changeSorting, addOfferToFavorities, removeOfferFromFavorities, } = this.props;
        if (isReadyApp) {
            return (React.createElement(React.Fragment, null,
                React.createElement(react_router_dom_1.Switch, null,
                    React.createElement(react_router_dom_1.Route, { path: "/login", render: () => (isAuthUser ? React.createElement(react_router_dom_1.Redirect, { exact: true, to: "/" }) : React.createElement(SignIn_1.default, { onSignIn: this.handleSignIn })) }),
                    React.createElement(react_router_dom_1.Route, { exact: true, path: "/", render: () => (React.createElement(MainPage_1.default, { addOfferToFavorities: addOfferToFavorities, changeCity: changeCity, changeSorting: changeSorting, cities: cities, currentCity: currentCity, isAuthUser: isAuthUser, offers: offers, removeOfferFromFavorities: removeOfferFromFavorities, user: user })) }),
                    React.createElement(react_router_dom_1.Route, { path: "/offer/:id", render: () => (React.createElement(PlaceCard_1.default, { addOfferToFavorities: addOfferToFavorities, isAuthUser: isAuthUser, removeOfferFromFavorities: removeOfferFromFavorities, user: user })) }),
                    React.createElement(PrivateRoute_1.default, { component: () => (React.createElement(FavoriteList_1.default, { isAuthUser: isAuthUser, isEmpty: !this.haveFavoritePlaceCard(), offers: favoriteOffers, user: user, onAddOfferToFavorities: addOfferToFavorities, onRemoveOfferFromFavorities: removeOfferFromFavorities })), isAuth: isAuthUser, path: "/favorites" })),
