...
class AddReviewsForm extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Form_1.default, { className: "reviews__form", method: "post", onSubmit: this.handleSubmit },
            ...
            React.createElement("textarea", { className: "reviews__textarea form__textarea", id: "review", name: "review", placeholder: "Tell how was your stay, what you like and what can be improved", value: review, onChange: this.handleChange }),
            React.createElement("div", { className: "reviews__button-wrapper" },
                React.createElement("p", { className: "reviews__help" },
                    ...
                    React.createElement("b", { className: "reviews__text-amount" },
                        ...
                        " characters"),
                    "."),
                React.createElement(Button_1.default, { className: "reviews__submit form__submit", disabled: this.isLocked(), type: "submit" }, "Submit"))));
    }
}
