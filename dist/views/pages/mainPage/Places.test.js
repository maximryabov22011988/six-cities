...
it('Places renders correctly with mandatory props', () => {
    const tree = renderer
        ...
        React.createElement(Places_1.default, { offers: offers, searchResultText: "1 places to stay in Paris", onActiveOfferClick: jest.fn(), onAddToFavorities: jest.fn(), onChangeSorting: jest.fn(), onRemoveFromFavorities: jest.fn() }))).toJSON();
