...
function PlaceCard({
  ...
  return React.createElement(
    ...
    React.createElement(Header_1.default, {
      ...
      userInfo: React.createElement(UserInfo_1.default, { avatarUrl: userAvatarUrl, email: email, isAuth: isAuthUser }),
    }),
    React.createElement(
      'main',
      ...
      React.createElement(
          ...
          React.createElement(
            ...
            images.map((src, i) => {
              if (i < MAX_IMAGES) {
                return React.createElement(
                  'div',
                  { className: 'property__image-wrapper', key: i },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement('b', { className: 'property__price-value' }, '\u20AC', price),
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                goods.map((good, i) => React.createElement('li', { className: 'property__good-item', key: i }, good))
              )
            ),
            React.createElement(
              'div',
        ...
        React.createElement(Map_1.default, {
      ...
      React.createElement(NearPlaces_1.default, {
        offers: nearOffers,
