...
it('Click on the image link in PlaceCard should work correctly', () => {
    ...
    const tree = shallow(React.createElement(PlaceCard_1.default, { className: "cities", offer: offer_1.default, onActiveOfferClick: handleActiveOfferClick, onAddToFavorities: jest.fn(), onRemoveFromFavorities: jest.fn() }));
